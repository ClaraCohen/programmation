...
// fonctions exemplifiant la librairie Chartist
// une fois le code javascript chartist.min.js ajouté au dossier, il est possible
// d'accéder aux visualisations de Chartist en créant des objets.
...
function graphiqueLigne() {
    let data = {
        labels: ["a", "b", "c", "d"],
        series: [[1, 2, 3, 4]] // notez les doubles parenthèses comparé à Camembert : on peut gérer plusieurs séries de chiffres (plusieurs courbes sur le graphique)
    };
